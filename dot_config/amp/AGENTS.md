...
- unless another tool is in place, ensure mise is used to manage runtime versions specific to a project
- prefer the kotlin DSL over groovy DSL for gradle projects
- ALWAYS use pnpm instead of npm for new node-based projects
...
- If there is insufficient documentation available for implementing a feature,
  use the librarian to explore the source code of a dependency, or find other examples of usage.
