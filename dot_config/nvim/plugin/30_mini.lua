...
-- special buffers (like 'mini.files') to not conflict
...
later(function()
  ...
  local ai_textobjects = {
    ...
    { '<', 'Balanced <>' },
    { '>', 'Balanced <>' },
    { 'b', 'Balanced bracket alias' },
    { '"', 'Balanced quote' },
    { "'", 'Balanced quote' },
    { '`', 'Balanced quote' },
    { 'q', 'Balanced quote alias' },
    { '?', 'Prompted textobject' },
    { 't', 'Tag' },
    { 'f', 'Function call' },
    { 'a', 'Argument' },
  ...
  local gen_ai_clues = function(prefixes)
    local clues = {}

    for _, prefix in ipairs(prefixes) do
      for _, textobject in ipairs(ai_textobjects) do
        table.insert(clues, { mode = { 'o', 'x' }, keys = prefix .. textobject[1], desc = textobject[2] })
      end
    end
  ...
  miniclue.setup({
    ...
    clues = {
      ...
      -- mini.ai textobjects
      { mode = { 'o', 'x' }, keys = 'a', desc = '+Around textobject' },
      { mode = { 'o', 'x' }, keys = 'i', desc = '+Inside textobject' },
      { mode = { 'o', 'x' }, keys = 'an', desc = '+Around next textobject' },
      { mode = { 'o', 'x' }, keys = 'al', desc = '+Around last textobject' },
      { mode = { 'o', 'x' }, keys = 'in', desc = '+Inside next textobject' },
      { mode = { 'o', 'x' }, keys = 'il', desc = '+Inside last textobject' },
      gen_ai_clues({ 'a', 'i', 'an', 'al', 'in', 'il' }),
    ...
    triggers = {
      ...
      { mode = { 'o', 'x' }, keys = 'a' },        -- mini.ai textobjects
      { mode = { 'o', 'x' }, keys = 'i' },
      { mode = { 'n', 'x' }, keys = "'" },        -- Marks
      { mode = { 'n', 'x' }, keys = '`' },
